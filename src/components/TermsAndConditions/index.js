...
export function _TermsAndConditions() {
  return (
    <div className={styles.content}>
      ...
      <p className={styles.paragraph}>
        ...
        fornecido pela e deve ser usado no estado em que se encontra.
      </p>
      <p className={styles.paragraph}>
      ...
      <p className={styles.paragraph}>
        O aplicativo web Mineiríssimo armazena e processa dados pessoais que
        você nos forneceu, a fim de fornecer nossos Serviços. É sua
        responsabilidade manter seus aparelhos e acesso ao Serviços seguro.
        Portanto, recomendamos que você faça não desbloquear ou fazer root em
        seu telefone, que é o processo de removendo as restrições e limitações
        de software impostas pelo sistema operacional oficial do seu
        dispositivo. Poderia fazer o seu telefone vulnerável a malware / vírus /
        programas maliciosos, comprometer os recursos de segurança do seu
        telefone e isso pode significar que o aplicativo web Mineiríssimo não
      ...
      <p className={styles.paragraph}>
        ...
        de que os termos do contrato com seu provedor de rede móvel ainda se
        aplicam. Como resultado, você pode ser cobrado por sua operadora de
        celular pelo custo dos dados durante a conexão ao acessar os Serviços ou
        outras cobranças de terceiros. Ao usar os Serviços, você aceita a
        responsabilidade por quaisquer cobranças, incluindo taxas de roaming de
        dados, se usar os Serviços fora de seu território (ou seja, região ou
        país) sem desligar o roaming de dados. Se você não é o pagador de contas
        do dispositivo no qual está usando os Serviços, esteja ciente de que
        presumimos que você recebeu permissão do pagador de contas para usar os
        Serviços.
      </p>
      <p className={styles.paragraph}>
      ...
      <p className={styles.paragraph}>
        ...
        aplicativo móvel está atualmente disponível em Android &amp; iOS - os
